...
def get_pose3D(video_path, output_dir):
    ...
    for i in tqdm(range(video_length)):
        ...
        output_dir_3D_keypoints = output_dir + 'pose3D_keypoints/'
        os.makedirs(output_dir_3D_keypoints, exist_ok=True)
        npz_file_name = output_dir_3D_keypoints + str(('%04d' % i)) + '_3D_keypoints.npz'
        np.savez_compressed(npz_file_name, keypoints_3d=post_out)
